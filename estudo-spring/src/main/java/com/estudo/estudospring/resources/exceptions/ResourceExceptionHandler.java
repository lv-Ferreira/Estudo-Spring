package com.estudo.estudospring.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(ResourceNotFoundException.class)//tratamento personalizado dessa excecao
	...
	@ExceptionHandler(DatabaseException.class)//tratamento personalizado dessa excecao
